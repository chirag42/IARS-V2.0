        ...
        <div class="col-md-8">
            <div class="card" style="margin-top: 40px">
                <div class="card-body">
                    ...
                    <form method="POST" action = "/teacher/insert_oral_prac" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iars finmaster\resources\views/Teacher/oral_prac.blade.php ENDPATH**/ ?>