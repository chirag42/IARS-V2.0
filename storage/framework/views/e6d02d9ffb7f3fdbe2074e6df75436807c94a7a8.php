...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form method = "POST" action = "/teacher/updateprofile/<?php echo e($profile->id); ?>">
                    <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="phone_no"  type="text" class="form-control" name="phone_no" value="<?php echo e($profile->phone_no); ?>" required>
                            </div>
                            </div>
                        </div>
                        <div class="form-group row">
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Internal-Assesment-master\resources\views/Teacher/updateprofile.blade.php ENDPATH**/ ?>