        ...
        <div class="col-md-8">
            <div class="card" style="margin-top: 40px">
                <div class="card-body">
                    ...
                    <form method="POST" action = "<?php echo e(action('TeachersController@displaytermworkOP')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                <div class="form-group row">    
                    <label class="col-md-4 col-form-label text-md-right">Select Class:<?php echo e($idno); ?></label>
                        <div class="col-md-4">  
                ...
                <input type="hidden" id="custId" name="idno" value="<?php echo e($idno); ?>">
...
<?php endif; ?>
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Internal-Assesment-master\resources\views/Teacher/selectsubject.blade.php ENDPATH**/ ?>