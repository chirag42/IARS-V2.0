        ...
        <div class="col-md-8">
            <div class="card" style="margin-top: 40px">
                <div class="card-body">
                    ...
                    <form method="POST" action = "{{action('TeachersController@displaytermworkOP')}}" enctype="multipart/form-data">
                    @csrf
                <div class="form-group row">    
                    <label class="col-md-4 col-form-label text-md-right">Select Class:{{$idno}}</label>
                        <div class="col-md-4">  
                ...
                <input type="hidden" id="custId" name="idno" value="{{$idno}}">
