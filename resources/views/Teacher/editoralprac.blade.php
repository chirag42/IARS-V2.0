                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        @foreach($orals as $oral)
                            <tr>
                                {{-- <td>{{$loop -> index+1 }}</td> --}}
                                <td>{{$oral['rollno'] }}</td>
                                <td>{{$oral['full_name'] }}</td>
                                <td>{{$oral[$subject->subject.'_marks'] }}</td>
                                {{-- <td><a href=# method="get" class="btn sub_btn" style="color:black;">Edit</a></td> --}}
                                <td><a href="{{action('TeachersController@editOralPrac',[$oral['rollno'],$subject->subject] )}}" method="get" class="btn sub_btn" style="color:black;">Edit</a></td>
                            </tr>  
